...
import { Bell, UserCircle, LogOut, Sun, Moon, Wrench } from 'lucide-react';
    ...
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-gutter bg-[#022448] text-white h-18 shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="p-2 hover:bg-white/10 transition-colors rounded-full relative">
          ...
          <span className="absolute top-2 right-2 w-2 h-2 bg-amber-500 rounded-full border border-primary"></span>
        </button>
        
        <div className="flex items-center gap-3 pl-4 border-l border-white/20">
          <div className="text-right hidden sm:block">
            <p className="text-[10px] font-bold uppercase tracking-wider opacity-70">LABORATORIO TÉCNICO</p>
