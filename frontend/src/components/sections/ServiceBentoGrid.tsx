    ...
    <section className="py-20 bg-surface dark:bg-slate-950/20">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 h-auto md:h-[550px]">
          {/* Item Grande: Laptop */}
          <div className="md:col-span-2 md:row-span-2 bg-white dark:bg-slate-900 p-8 rounded-3xl border border-outline-variant/60 dark:border-slate-800/80 shadow-md flex flex-col justify-between group hover:shadow-2xl hover:border-primary dark:hover:border-sky-500 hover:-translate-y-1 transition-all duration-300">
            <div>
          ...
          <div className="md:col-span-2 bg-gradient-to-br from-secondary to-sky-500 dark:from-[#061533] dark:to-[#020816] p-8 rounded-3xl text-white flex flex-col sm:flex-row items-center gap-6 group overflow-hidden border border-outline-variant/10 dark:border-slate-850 shadow-md hover:shadow-2xl hover:border-secondary dark:hover:border-sky-500 hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-outline-variant/60 dark:border-slate-800/80 shadow-md flex flex-col justify-center gap-4 group hover:shadow-2xl hover:border-primary dark:hover:border-sky-500 hover:-translate-y-1 transition-all duration-300">
