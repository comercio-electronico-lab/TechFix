...
export const ShowcaseButtons: React.FC<ShowcaseButtonsProps> = ({ product }) => {
  ...
  return (
    <div className="flex justify-center items-center gap-3 pt-2">
      ...
      <button 
        onClick={handleBuy}
        className="border border-[#0071e3] text-[#0071e3] bg-transparent hover:bg-[#0071e3] hover:text-white text-sm font-normal px-4 py-1.5 rounded-full transition-all duration-300 cursor-pointer active:scale-95"
      >
        Comprar
      </button>
    </div>
