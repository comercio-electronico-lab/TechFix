    ...
    <Container as="section" className="-mt-16 relative z-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <ScrollReveal variant="fade-up" delay="0" className="h-full">
          <div className="group bg-white dark:bg-slate-900 border border-outline-variant/60 dark:border-slate-800 rounded-3xl p-8 md:p-10 shadow-2xl flex flex-col justify-between hover:border-primary dark:hover:border-sky-500 hover:-translate-y-1 transition-all duration-300 relative overflow-hidden h-full">
